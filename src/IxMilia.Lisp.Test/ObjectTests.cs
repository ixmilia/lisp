...
namespace IxMilia.Lisp.Test
{
    public class ObjectTests
    {
        ...
        public void IsNil()
        {
            ...
            Assert.False(new LispCodeFunction("function", null, Enumerable.Empty<string>(), Enumerable.Empty<LispObject>()).IsNil());
            ...
            Assert.False(new LispQuotedLambdaFunctionReference(new LispCodeFunction("function", null, Enumerable.Empty<string>(), Enumerable.Empty<LispObject>())).IsNil());
        ...
        public void IsTLike()
        {
            ...
            Assert.True(new LispCodeFunction("function", null, Enumerable.Empty<string>(), Enumerable.Empty<LispObject>()).IsTLike());
            ...
            Assert.True(new LispQuotedLambdaFunctionReference(new LispCodeFunction("function", null, Enumerable.Empty<string>(), Enumerable.Empty<LispObject>())).IsTLike());
