...
(defun list-helpers ()
    ...
    (assert-eq '(b n n a) (remove 'a '(b a n a n a) :count 2 :from-end) "remove with :count and empty :from-end")
    (assert-eq '(b n n a) (remove 'a '(b a n a n a) :count 2 :from-end nil) "remove with :count and nil :from-end")
    (assert-eq '(b a n n) (remove 'a '(b a n a n a) :count 2 :from-end t) "remove with :count and t :from-end")
    (assert-eq '(b a n n) (remove 'a '(b a n a n a) :count 2 :from-end 'a) "remove with :count and non-nil :from-end")
